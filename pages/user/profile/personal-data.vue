<template>
	<view>
		<!--标题栏-->
		<!-- <bar-title bgColor="bg-white" isBack><block slot="content">个人资料</block></bar-title> -->
		...
		<view class="cu-list menu sm-border margin-top">
			<view class="cu-item arrow" @tap="editPhoneTap">
				...
				<view class="action"><text class="text-gray">138****8000</text></view>
			</view>
			<view class="cu-item arrow" @tap="regionTap">
				<view class="content">地区</view>
				<view class="action"><text class="text-gray">太阳</text></view>
			</view>
			<view class="cu-item arrow" @tap="addressTap"><view class="content">收货地址</view></view>
			<view class="cu-item arrow" @tap="editContactCardsTap"><view class="content">联系卡</view></view>
		</view>
