<template>
	<view>
		...
		<!-- <bar-title bgColor="bg-white" isBack>
			...
			<block slot="right"><text class="text-black">使用说明</text></block>
		</bar-title> -->
		...
		<view class="zaiui-sponsored-card-view">
			<view class="card-price-view">
				...
				<view class="btn-right-view"><button class="cu-btn bg-red round sm">去使用</button></view>
			</view>
