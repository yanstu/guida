<template>
	<view>
		...
		<view class="zaiui-status-image-view">
			<image src="../../../static/image/real_name/non_real_name.png" mode="widthFix" v-if="!status" @tap="statusTap" />
			<image src="../../../static/image/real_name/real_name.png" mode="widthFix" v-if="status" @tap="statusTap" />
		</view>
		...
		<!--按钮-->
		<view class="zaiui-btn-view" v-if="!status"><button class="cu-btn bg-red radius" @tap="btnTap">去认证</button></view>
	</view>
</template>
