<template>
	<view class="container">
		...
		<view class="btn-box">
				<view class="item"><button class="cu-btn bg-green shadow-blur round">导入发票抬头</button></view>
				<view class="item"><button class="cu-btn bg-blue shadow-blur round">提交</button></view>
		</view>
	</view>
</template>
