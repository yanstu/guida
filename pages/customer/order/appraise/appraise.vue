<template>
	<view>
		<!--标题栏-->
		<!-- <bar-title bgColor="bg-white" isBack><block slot="content">交易评价</block></bar-title> -->
		...
		<view class="bg-white zaiui-content-view">
			...
			<view class="zaiui-score-view">
				<view class="item-score">
					...
					<view class="score-img-view">
						<view class="img-view">
							<view class="cu-avatar sm" style="background-image:url('../../../../static/image/order/appraise/a1.png')" />
							<view class="text-gray text-center title">不愿意</view>
						</view>
						<view class="img-view">
							<view class="cu-avatar sm" style="background-image:url('../../../../static/image/order/appraise/a2.png')" />
							<view class="text-gray text-center title">一般</view>
						</view>
						<view class="img-view">
							<view class="cu-avatar sm" style="background-image:url('../../../../static/image/order/appraise/a3s.png')" />
				...
				<view class="item-score">
					...
					<view class="score-img-view">
						...
						<view class="img-view">
							<view class="cu-avatar sm" style="background-image:url('../../../../static/image/order/appraise/a2s.png')" />
							<view class="text-gray text-center title">一般</view>
						</view>
						<view class="img-view">
							<view class="cu-avatar sm" style="background-image:url('../../../../static/image/order/appraise/a3.png')" />
				...
				<view class="item-score">
					...
					<view class="score-img-view">
						<view class="img-view">
							<view class="cu-avatar sm" style="background-image:url('../../../../static/image/order/appraise/a1s.png')" />
			...
			<!--评价内容-->
			<view class="cu-form-group solid-top"><textarea placeholder="随手评价,造福你我他" /></view>
					...
					<view class="grid col-5">
						<block v-for="(item, index) in imgList" :key="index">
							<view class="bg-img" @tap="ViewImage" :data-url="imgList[index]">
								...
								<view class="cu-tag sm bg-red" @tap.stop="DelImg" :data-index="index"><text class="cuIcon-close"></text></view>
							</view>
						</block>
						<view class="add-view" @tap="ChooseImage"><text class="cuIcon-add"></text></view>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="bg-white zaiui-btn-view zaiui-foot-padding-bottom">
			<view class="flex flex-direction"><button class="cu-btn bg-red">提交评价</button></view>
		</view>
	</view>
</template>
