<template>
	<view class="zaiui-home-box" :class="show ? 'show' : ''">
			...
			<view class="zaiui-flex-tab show">
				<view class="flex text-white">
					...
					<view class="basis-xxs">
						<view class="sort-icon" @tap="sortVueTap"><text class="cuIcon-sort" /></view>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="zaiui-view-content" :class="[viewContent.welcome ? 'welcome' : '', headTab.TabCur == 0 ? 'show' : '']">
			...
			<!--红包块-->
			<view class="bg-red margin radius padding-sm"><image class="red-envelopes" src="/static/images/home/sundry/2.png" mode="widthFix" /></view>
		...
		<view class="zaiui-view-content" :class="headTab.TabCur != 0 ? 'show' : ''">
			...
			<view class="margin"><image class="zaiui-ad-img" src="/static/images/home/swiper/swiper-1.png" mode="widthFix" /></view>

			<!--标题-->
			<view class="margin-bottom-sm zaiui-tab-list-title">
				<view class="flex flex-wrap">
					<view class="basis-sm text-right"><image class="img-aau" src="/static/zaiui/img/aau.png" lazy-load mode="widthFix" /></view>
					<view class="basis-xs text-center"><text class="text-black text-xl text-bold">为您推荐</text></view>
					<view class="basis-sm text-left"><image class="img-aau" src="/static/zaiui/img/aau.png" lazy-load mode="widthFix" /></view>
				</view>
			</view>
		...
		<!--打赏-->
		<view class="zaiui-add-btn-view-box" @tap="rewardTap"><button class="cu-btn cuIcon-likefill bg-red"></button></view>
	</view>
</template>
