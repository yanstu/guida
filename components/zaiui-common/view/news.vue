<template>
	<view class="zaiui-news-box" :class="show ? 'show' : ''">
		...
		<view class="cu-bar bg-white zaiui-follow-box">
			<view class="action action-text-cut"><view class="text-cut-2 text-sm">关注微信公众号,通过微信随时接收用户咨询、订单状态</view></view>
			<view class="action"><button class="cu-btn sm bg-red">立即关注</button></view>
		</view>
		...
		<view class="bg-white zaiui-news-list-box">
			<view class="margin-bottom cu-list menu-avatar">
				<view
					...
					@tap="tapNews(0)"
				>
					<view class="cu-avatar round" style="background-image:url(/static/images/news/4.png);"><view class="cu-tag badge" /></view>
					<view class="content">
				...
				<view
					...
					@tap="tapNews(1)"
				>
					<view class="cu-avatar round" style="background-image:url(/static/images/avatar/1.jpg);"><view class="cu-tag badge" /></view>
					<view class="content">
						<view class="text-black">
							<text class="margin-right-xs">仔仔</text>
							<text class="cu-tag bg-blue sm radius"><text class="cuIcon-male"></text></text>
						</view>
						<view class="text-gray text-sm text-cut">欢迎使用本模板</view>
						<view class="text-gray text-sm">4小时前</view>
					</view>
					<view class="action"><view class="cu-avatar radius" style="background-image:url(/static/images/home/goods/11.png);" /></view>
					<view class="move">
						<view class="bg-grey">置顶</view>
						<view class="bg-red">删除</view>
					</view>
				...
				<view
					...
					@tap="tapNews(2)"
				>
					<view class="cu-avatar round" style="background-image:url(/static/images/avatar/2.jpg);"><view class="cu-tag badge" /></view>
					<view class="content">
						<view class="text-black">
							<text class="margin-right-xs">仔仔22</text>
							<text class="cu-tag bg-pink sm radius"><text class="cuIcon-female"></text></text>
						</view>
						<view class="text-gray text-sm text-cut">希望打个赏哦~</view>
						<view class="text-gray text-sm">6小时前</view>
					</view>
					<view class="action"><view class="cu-avatar radius" style="background-image:url(/static/images/home/goods/10.png);" /></view>
					<view class="move">
						<view class="bg-grey">置顶</view>
						<view class="bg-red">删除</view>
					</view>
