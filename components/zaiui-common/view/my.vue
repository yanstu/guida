	...
	<view class="zaiui-my-box" :class="show ? 'show' : ''">
		<view class="bg-gradual-red zaiui-head-box">
			...
			<view class="zaiui-user-info-box">
				...
				<view class="login-user-view" v-if="login">
					<view class="login-user-avatar-view"><view class="cu-avatar round lg" style="background-image:url(/static/images/avatar/1.jpg);" /></view>
		...
		<view class="zaiui-view-content">
			...
			<view class="padding-xs bg-white zaiui-user-info-order-box">
				...
				<view class="cu-list grid col-4 no-border">
					<view class="cu-item">
						<view class="text-xxl text-red" v-if="login"><text class="cuIcon-presentfill"></text></view>
						<view class="text-xxl text-black" v-else>0</view>
						<text class="text-sm">我发布的</text>
					</view>
					<view class="cu-item">
						<view class="text-xxl text-red" v-if="login"><text class="cuIcon-sponsorfill"></text></view>
						<view class="text-xxl text-black" v-else>1</view>
						<text class="text-sm">我卖出的</text>
					</view>
					<view class="cu-item" @tap="order_list_tap">
						<view class="text-xxl text-red" v-if="login"><text class="cuIcon-cartfill"></text></view>
						<view class="text-xxl text-black" v-else>2</view>
						<text class="text-sm">我买到的</text>
					</view>
					<view class="cu-item">
						<view class="text-xxl text-red" v-if="login"><text class="cuIcon-favorfill"></text></view>
