		...
		<view class="cu-list grid col-2">
			<view class="cu-item">
				...
				<view class="flex p-xs margin-tb mb-sm">
					...
					<view class="flex-sub">
						<view class="padding-right-sm"><image class="location-img" src="/static/images/home/sundry/9.png" mode="widthFix"></image></view>
					</view>
				</view>
			</view>
			<view class="cu-item">
				<view class="grid col-2">
					<view class="padding-left-sm" v-for="(item, index) in list_data" :key="index" v-if="index < 2" @tap="listTap(item, index)">
						...
						<view class="margin-tb-sm"><image class="width-img" :src="item.img" mode="widthFix"></image></view>
					</view>
				</view>
			</view>
			<view class="cu-item">
				<view class="grid col-2 padding-right-sm margin-top-sm">
					<view class="padding-lr-xs" v-for="(item, index) in list_data" :key="index" v-if="index >= 2 && index < 4" @tap="listTap(item, index)">
						<view class="text-black text-bold text-left ">{{ item.title }}</view>
						<view class="margin-top-sm"><image class="width-img" :src="item.img" mode="widthFix"></image></view>
					</view>
				</view>
			</view>
			<view class="cu-item">
